...
@interface LoginViewCotroller : UIViewController <ParserProtocolDelegate,clientProtocolDelegate,UITextFieldDelegate,overlayDelegate,FBRequestDelegate, FBSessionDelegate,socialResponseDelegate, GPXDelegate>  
{
