...
-(void) displayView
{
    if(IsSignUpView)
    {
        self.newUserName.placeholder = @"UserName";
        self.newUserName.keyboardType = UIKeyboardTypeDefault;
        self.email.placeholder       = @"Email";
        self.email.returnKeyType = UIReturnKeyNext;
        self.newUserName.tag = 3;
        self.email.tag       = 4;
        self.email.secureTextEntry = FALSE;
        self.TCLabel.hidden = FALSE;
        self.newconfirmPassword.hidden = FALSE;
        self.newPassword.hidden = FALSE;
        [self.topImageView setImage:[UIImage imageNamed:@"SignupStrip.png"]];
        [barButtonItem setTitle:@"Sign Up"];
        
    }
    else
    {
        self.newUserName.placeholder = @"Email";
        self.newUserName.keyboardType = UIKeyboardTypeEmailAddress;
        self.email.placeholder       = @"Password";
        self.email.returnKeyType = UIReturnKeyDone;
        self.newUserName.tag = 1;
        self.email.tag       = 2;
        self.email.secureTextEntry = TRUE;
        self.TCLabel.hidden = TRUE;
        self.newPassword.hidden = TRUE;
        self.newconfirmPassword.hidden = TRUE;
        [self.topImageView setImage:[UIImage imageNamed:@"SigninStrip.png"]];
        [barButtonItem setTitle:@"Sign In"];
...
-(IBAction) signInMethod :(id)sender
{
   ...
   {
    if([self validateAppRegistration])
    {
        reqType = 2;
        [self syncOnThreadAction];
    }
